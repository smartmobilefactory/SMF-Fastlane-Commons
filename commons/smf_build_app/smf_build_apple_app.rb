private_lane :smf_build_apple_app do |options|
  ...
  # TEMP: -jobs 2 to debug sporadic CI build failures (race conditions in parallel builds)
  xcargs_string = "#{smf_xcargs_for_build_system} CODE_SIGN_STYLE=Manual -skipPackagePluginValidation -jobs 2"
  if build_number
