...
private_lane :smf_pull_keystore do |options|
  ...
  keystore_values = {}
  keystore_values[:keystore_file] = File.absolute_path("#{clone_root_folder}/Android-Keystores/keystores/#{keystoreFolder}/keystore.jks")
  keystore_values[:keystore_password] = properties[$SMF_KEYSTORE_PASSWORD_KEY]
  keystore_values[:keystore_key_alias]  = properties[$SMF_KEYSTORE_KEY_ALIAS_KEY]
  keystore_values[:keystore_key_password] = properties[$SMF_KEYSTORE_KEY_PASSWORD_KEY]
