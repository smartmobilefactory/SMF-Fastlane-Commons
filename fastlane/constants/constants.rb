...
$DANGER_UNDEFINED_PROPERTIES_CONFIG_JSON = 'UNDEFINED_PROPERTIES_IN_CONFIG_JSON'
$DANGER_UNDEFINED_PROPERTIES_BUILD_CONFIG = 'UNDEFINED_PROPERTIES_IN_BUILD_CONFIGURATION'
...
# Undefined properties in config.json/iOS build configuration
