...
$SMF_CI_METADB_SUCCESS_LOG = 'metadb-success-log'
...
## Google Spreadsheet identifiers and info for the financial reporting
$REPORTING_GOOGLE_SHEETS_MANUAL_FINANCE_DOC_ID_KEY = 'MANUAL_FINANCIAL_REPORTING'
$REPORTING_GOOGLE_SHEETS_MANUAL_FINANCE_SHEET_NAME = 'overview'
$REPORTING_GOOGLE_SHEETS_AUTO_FINANCE_DOC_ID_KEY = 'AUTOMATIC_FINANCIAL_REPORTING'
$REPORTING_GOOGLE_SHEETS_AUTO_FINANCE_SHEET_NAME = 'playground' # 'overtime'
$REPORTING_GOOGLE_SHEETS_FINANCE_AIO_IMPORT_SHEET_NAME = 'playground_kevin' # 'Import'
...
$CONFIG_OPTIONAL_PROJECT_KEYS_IOS = ['custom_credentials']
