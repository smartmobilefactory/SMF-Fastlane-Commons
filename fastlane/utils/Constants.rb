...
$CONFIG_DEPRECATED_FILES_FOLDERS_COMMONS = ['.codebeatignore', '.codebeatsettings', '.codeclimate.yml', 'smf.properties'] # + '.MetaJSON'
...
$CONFIG_REQUIRED_PROJECT_KEYS_IOS = ['xcode_version', 'oktotest'] # - 'oktotest'
...
$CONFIG_OPTIONAL_PROJECT_KEYS_IOS = ['meta_db_name', 'programming_language']
$CONFIG_OPTIONAL_PROJECT_KEYS_ANDROID = []
$CONFIG_OPTIONAL_PROJECT_KEYS_FLUTTER = []

# Deprecated Config.json/build_variants
$CONFIG_DEPRECATED_BUILD_VARIANT_KEYS_IOS = ['pr.archive_ipa', 'upload_itc', 'itc_team_id', 'match'] # only 'pr.archive_ipa'
