...
# android build app
$SMF_KEYSTORE_FILE_KEY = 'KEYSTORE_FILE'
$SMF_KEYSTORE_PASSWORD_KEY = 'KEYSTORE_PASSWORD'
$SMF_KEYSTORE_KEY_ALIAS_KEY = 'KEYSTORE_KEY_ALIAS'
$SMF_KEYSTORE_KEY_PASSWORD_KEY = 'KEYSTORE_KEY_PASSWORD'
